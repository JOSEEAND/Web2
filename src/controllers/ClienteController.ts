...
export class ClienteController{
    ...
    static update=async(req:Request,res:Response)=>{
        try {
            ...
            try {
                ...
                return res.status(201).json({mensaje:'Cliente actualizado correctamente'});
            } catch (error) {
                return res.status(404).json({mensaje:'No se pudo modificar el cliente'});
            }
    ...
    static delete=async(req:Request,res:Response)=>{
        try {
            ...
            if(!codigo){
                return res.status(404).json({mensaje:'Debe indicar el codigo del cliente'});
            }
            ...
            try {
                ...
                return res.status(404).json({mensaje:'No se pudo eliminar el cliente'});
            }
